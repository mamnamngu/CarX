...
public class TeamController {
	...
	public ResponseEntity<List<TeamDTO>> retrieveAllTeams(){
		return ResponseEntity.ok(teamService.display(teamService.findAll()));
    }
	...
	public ResponseEntity<List<TeamDTO>> findByTournamentIdForDisplay(@PathVariable long schoolTourId){
		...
		if(schoolTour != null) {
			...
			return ResponseEntity.ok(teamService.display(ls));
		}
